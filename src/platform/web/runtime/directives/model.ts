    ...
    if (vnode.tag === 'select') {
      ...
      if (curOptions.some((o, i) => !looseEqual(o, prevOptions[i]))) {
        ...
        const needReset = el.multiple
          ? (<any[]>binding.value).some(v => hasNoMatchingOption(v, curOptions))
...
function setSelected (el:any, binding:any, vm:any) {
...
function actuallySetSelected (el:any, binding:any, vm:any) {
...
function hasNoMatchingOption (value:any, options:any) {
  return (<any[]>options).every(o => !looseEqual(o, value))
}
