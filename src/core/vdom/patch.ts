...
export function createPatchFunction (backend:any) {
  ...
  function isUnknownElement (vnode:VNode, inVPre:any) {
    return (
      !inVPre &&
      !vnode.ns &&
      !(
  ...
  function createComponent (vnode:VNode, insertedVnodeQueue:any, parentElm:any, refElm:any) {
  ...
  function reactivateComponent (vnode:VNode, insertedVnodeQueue:any, parentElm:any, refElm:any) {
    let i
  ...
  function createChildren (vnode:VNode, children:any, insertedVnodeQueue:any) {
