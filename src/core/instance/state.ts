...
export function proxy (this:any,target: any, sourceKey: string, key: string):any {
  sharedPropertyDefinition.get = function proxyGetter () {
    return (<any>this)[sourceKey][key]
  }
  sharedPropertyDefinition.set = function proxySetter (val) {
    (<any>this)[sourceKey][key] = val
  }
...
function createComputedGetter (key:any) {
...
export function stateMixin (Vue: ComponentCtor) {
  ...
  // the object here.
  const dataDef:any = {}
  dataDef.get = function (this:any) { return this._data }
  const propsDef:any = {}
  propsDef.get = function (this:any) { return this._props }
  if (process.env.NODE_ENV !== 'production') {
